...
<div class="container border rounded my-2 bg-danger">
	<div class="badge badge-white my-4" style="width:30rem; background-color:#FA5C67;">
		<h1 class="text-white">Comentarios</h1>
	</div>

        <?php
            $sql="select u.nombrecom nombrecom, DATE_FORMAT(c.fechacal, '%d-%m-%Y') as fechacal, c.valoracion valoracion, c.comentario comentario from calificai c, usuario u where u.id=c.idcliente and c.idinst = ?";
