...
$sql="update atractivo set img=:aimage where ID=:imgid";
...
<html>
<head>
<title>CHC | Admin Attractive Creation</title>
...
<!---->
  <div class="grid-form1">
  	       <h3>Actualizar imagen de atractivo </h3>
  	         ...
  	         <div class="tab-content">
						...
						<?php 
$imgid=intval($_GET['imgid']);
$sql = "SELECT img from atractivo where ID=:imgid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':imgid', $imgid, PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-8">
<img src="attractiveimages/<?php echo htmlentities($result->img);?>" width="200">
</div>
</div>
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="file" name="attractiveimage" id="attractiveimage" required>
									</div>
								</div>	
								<?php }} ?>
