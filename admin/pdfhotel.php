...
<body>
	...
	<table id="table" class="inventory">
						<thead>
						  <tr>
						  <th>#</th>
						  <th>Nombre</th>
						...
						<tbody>
						<?php 
$sql = "select i.idinst idinst, i.nombre nombre, i.direccion direccion, i.telefono telefono, u.nombrecom nombrecom, i.bioseguridad from institucion i, usuario u where u.id=i.idencargado and i.idinst in (select idinst from hotel)";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
