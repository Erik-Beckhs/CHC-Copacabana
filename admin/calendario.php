...
$sql = "SELECT id, title, start, end, color, descripcion FROM events ";
		  ...
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="addEvent.php" enctype="multipart/form-data">
			  ...
			  <div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Agregar Festividad</h4>
			  </div>
			  <div class="modal-body">
				
				  <div class="form-group">
					<label for="title" class="col-sm-2 control-label">Festividad</label>
					<div class="col-sm-10">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  <select name="color" class="form-control" id="color">
						  ...
						  <option style="color:#ff0000;" value="#ff0000">&#9724; Cancelado</option>			  
						</select>
					</div>
				  </div>
				  <div class="form-group">
							...
							<div class="col-sm-8">
								<input type="file" name="festimage" id="festimage">
							</div>
					</div>
			  </div>
		...
		<div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="editEventTitle.php">
			  <div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="myModalLabel">Modificar Festividad</h4>
			  </div>
			  <div class="modal-body">
				  ...
				  <div class="form-group">
				    ...
				    <div class="form-group"> 
						<div class="col-sm-offset-2 col-sm-10">
						  <div class="checkbox">
							<label class="text-danger"><input type="checkbox"  name="delete"> Eliminar Festividad</label>
						  </div>
						</div>
					</div>
		...
		function edit(event){
			...
			$.ajax({
			 ...
			 success: function(rep) {
					if(rep == 'OK'){
						alert('La festividad se ha guardado correctamente');
					}else{
