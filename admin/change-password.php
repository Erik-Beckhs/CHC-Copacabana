...
<html>
<head>
<title>CHC | Admin Change Password</title>
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Inicio</a><i class="fa fa-angle-right"></i>Perfil <i class="fa fa-angle-right"></i> Cambiar Contraseña</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">

  <div class="grid-form1 col-md-8">
