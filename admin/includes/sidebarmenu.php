					...
					<a href="../index.php" class="sidebar-icon"><i class="fa fa-home"></i></a><a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> 
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									...
									<li id="menu-academico" ><a href="#"><i class="fas fa-mosque" aria-hidden="true"></i><span>Atractivos Turísticos</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										...
										{?>
										   <li id="menu-academico-avaliacoes" ><a href="create-package.php">Crear</a></li>
											<li id="menu-academico-avaliacoes" ><a href="manage-packages.php">Ver Paquetes</a></li>
										  <?php } ?>
									 ...
									 if($_SESSION['tipo']==1 || $_SESSION['tipo']==4)
										...
										<li id="menu-academico" ><a href="copia_seguridad/php/index.php"><i class="fa fa-save"></i><span>Copia de Seguridad</span>
										<div class="clearfix"></div></a>
										</li>
									...
									if($_SESSION['tipo']==2)
										{?>
										<li id="menu-academico-avaliacoes" ><a href="#"><i class="fas fa-clipboard-list"></i>Mis Reportes<span class="fa fa-angle-right" style="float: right"></span></a>
										   <ul id="menu-academico-sub" >
												   <li id="menu-academico-avaliacoes"><a href="reporte_reservas.php" style="width:200px;">Reservas e Ingresos</a></li>
												   <li id="menu-academico-avaliacoes"><a href="reporte_grafico.php?r=8" style="width:200px;">Calificación de Paquetes</a></li>
											</ul>
										</li>
										<?php
									}
