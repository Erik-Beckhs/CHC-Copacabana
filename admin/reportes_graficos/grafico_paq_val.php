...
$(function () {
    $('#container').highcharts({
        ...
        xAxis: {
            categories: [
<?php
$sql="select p.nombre nombre, tmp.val val from paquete p left join (select idpaq, avg(valoracion) val from calificap group by idpaq) tmp on p.idpaq=tmp.idpaq order by tmp.val desc limit 20";
