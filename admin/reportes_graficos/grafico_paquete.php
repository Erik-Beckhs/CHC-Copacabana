...
$sql="select * from paquete where tipopaq = 1";
$query=$dbh->prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$circuito=$query->rowCount();

$sql="select * from paquete where tipopaq = 2";
$query=$dbh->prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$estancia=$query->rowCount();

$sql="select * from paquete where tipopaq = 3";
$query=$dbh->prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$premium=$query->rowCount();
