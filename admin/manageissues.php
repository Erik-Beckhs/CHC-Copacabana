...
<html>
<head>
<title>CHC | Admin manage Issues</title>
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Manage Issues</h2>
						...
						<tbody>
<?php $sql = "SELECT tblissues.id as id,usuario.FullName as fname,usuario.MobileNumber as mnumber,usuario.EmailId as email,tblissues.Issue as issue,tblissues.Description as Description,tblissues.PostingDate as PostingDate from tblissues join usuario on usuario.EmailId=tblissues.UserEmail";
$query = $dbh -> prepare($sql);
$query->execute();
