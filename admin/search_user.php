...
<div class="agile-grids">	
				...
				<div class="agile-tables">
					...
					<form action="search_user.php" method="get" class="form_search">
						...
						<tbody>
<?php 
$sql = "SELECT * from usuario where nombrecom like '%$dato%' or email like '%$dato%' or telefono like '%$dato%'";
...
{				?>		
						  <tr>
							...
							$query1->execute([htmlentities($result->id)]);
							$results1=$query1->fetchAll(PDO::FETCH_OBJ);
							if($query1->rowCount() == 1)
							{
									$tipo='Administrador';
							}
							$sql1 = "SELECT * from cliente where id=?";
							$query1 = $dbh -> prepare($sql1);
							$query1->execute([htmlentities($result->id)]);
							$results1=$query1->fetchAll(PDO::FETCH_OBJ);
							if($query1->rowCount() == 1)
							...
							$sql1 = "SELECT * from encargado where id=?";
							$query1 = $dbh -> prepare($sql1);
							$query1->execute([htmlentities($result->id)]);
							$results1=$query1->fetchAll(PDO::FETCH_OBJ);
							if($query1->rowCount() == 1)
