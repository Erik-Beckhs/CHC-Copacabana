...
<div class="left-content">
	...
	<a href="reportes.php?r=2" target="_blank"><button class="btn btn-primary btn-lg" name="btnReserva" style="width:200px;"><i class="fas fa-print"></i> Imprimir</button></a>
	</div>
...
<?php 
$sql = "SELECT * from atractivo order by id desc limit 10";
...
{				?>		
						  <tr>
							...
							$sql1 = "SELECT * from categoria where idcat=?";
							$query1 = $dbh -> prepare($sql1);
							$query1->execute([htmlentities($result->idcat)]);
							$results1=$query1->fetchAll(PDO::FETCH_OBJ);
							if($query1->rowCount() == 1)
							{
								foreach($results1 as $result1)
								{
									$categoria=htmlentities($result1->nombrecat);
								}		
							}
