...
<div class="agile-grids">	
				...
				<div class="agile-tables" style="min-height:500px;">
		...
		<a href="package-list.php">
			<div class="btn badge badge-success" style="background-color:#02A9D9">
...
<?php 
$sql = "SELECT * from paquete p, reserva r where p.idpaq=r.idpaq and r.idus=?";
$query = $dbh -> prepare($sql);
$query->execute([$idcli]);
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
{		
    ...
    $total=intval(htmlentities($result->total));
    		?>		
						  <tr>
				...
				<?php }
					...
					echo "<br>";
					echo "Aún no contiene registros de reservas";
				}
				?>
...
<button class="btn btn-danger">
	<h3 class="text-right"><a href="javascript:history.go(-1)" style="color:white;"><i class="fas fa-arrow-circle-left"></i> Volver</a></h3>
</button>	
</div>
